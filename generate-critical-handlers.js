// Kritische fehlende IPC-Handler für index-portable.js
const fs = require('fs');
...
console.log('Kritische Handler generiert:');
console.log(criticalHandlers);

// Speichere in Datei für einfaches Kopieren
fs.writeFileSync('./critical-handlers.js', criticalHandlers);
console.log('\\n✅ Kritische Handler in critical-handlers.js gespeichert');
console.log('\\n📋 Diese Handler können jetzt in index-portable.js eingefügt werden');
