...
export default function CalendarWidget() {
  ...
  const handleOpenGoogleCalendar = () => {
    // Öffne Google Kalender in neuem Tab für vollständige Funktionalität
    window.open('https://calendar.google.com', '_blank');
  };

  const handleOpenOutlookCalendar = () => {
    // Öffne Outlook Kalender in neuem Tab
  ...
  return (
    <Card className="h-full">
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          Ihre Termine und Garten-Aktivitäten
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {/* Lokaler Kalender für Datum-Auswahl */}
        ...
        <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
          <p><strong>Tipp:</strong> Klicken Sie auf die Kalender-Buttons, um Ihre persönlichen Termine zu verwalten. 
          Nutzen Sie die Datumsauswahl für Ihre Gartenplanung.</p>
        </div>
      </CardContent>
    </Card>
  );
